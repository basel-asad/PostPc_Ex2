...
public class MainActivityTest {
  ...
  @Test
  public void when_userClicksDeleteButton_then_activityShouldForwardCallToCalculator_and_ShowTheExpectedCalculatorOutputRightAway() {
    // setup
    String expectedText = "delete button clicked";
    Mockito.when(mockCalculator.output()).thenReturn(expectedText);

    TextView activityMainTextView = activityUnderTest.findViewById(R.id.textViewCalculatorOutput);
    View deleteButton = activityUnderTest.findViewById(R.id.buttonBackSpace);
  ...
  public void when_userClicksEquals_then_activityShouldForwardCallToCalculator_and_ShowTheExpectedCalculatorOutputRightAway() {
    // setup
    String expectedText = "Equals button clicked";
    Mockito.when(mockCalculator.output()).thenReturn(expectedText);

    TextView activityMainTextView = activityUnderTest.findViewById(R.id.textViewCalculatorOutput);
    View equalsButton = activityUnderTest.findViewById(R.id.buttonEquals);
  ...
  public void when_userClicksClear_then_activityShouldForwardCallToCalculator_and_ShowTheExpectedCalculatorOutputRightAway() {
    // setup
    String expectedText = "clear button clicked";
    Mockito.when(mockCalculator.output()).thenReturn(expectedText);

    TextView activityMainTextView = activityUnderTest.findViewById(R.id.textViewCalculatorOutput);
    View clearButton = activityUnderTest.findViewById(R.id.buttonClear);
  ...
  // add tests for clicks on all buttons
